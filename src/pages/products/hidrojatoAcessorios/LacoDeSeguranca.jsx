            ...
            <table className="w-full border-collapse table-fixed bg-white">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  ...
                  <th className="py-6 px-2 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[15%]">{t('tabela.codigo')}</th>
                  <th className="py-6 px-2 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[15%]">{t('tabela.pressao')}</th>
                  <th className="py-6 px-2 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[15%]">{t('tabela.opcaorosca1')}</th>
                  <th className="py-6 px-2 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[15%]">{t('tabela.opcaorosca2')}</th>
                  <th className="py-6 px-2 font-bold text-sm md:text-base text-center w-[20%]">{t('tabela.aplicacao')}</th>
                </tr>
              </thead>
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-8 px-2 border-r border-gray-200 text-sm md:text-lg text-center">---</td>
                  <td className="py-8 px-2 text-sm md:text-lg text-center">{t("tabela.mangueiras")} 3/8 - 3/4</td>
                </tr>
              </tbody>
            </table>
          </div>
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-autoopacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    ...
                    <p><strong>{t('tabela.codigo')}:</strong> 3010.0010</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 500</p>
                    <p><strong>{t('tabela.opcaorosca1')}:</strong> ---</p>
                    <p><strong>{t('tabela.opcaorosca2')}:</strong> ---</p>
                    <p><strong>{t('tabela.aplicacao')}:</strong> {t('tabela.mangueiras')} 3/8 - 3/4</p>
                  </div>
                </div>
              </div>
            </div>
