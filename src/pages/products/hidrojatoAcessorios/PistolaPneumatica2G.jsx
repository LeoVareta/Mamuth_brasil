...
const PistolaPneumatica2G = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>{t('acessorioshidro.pneumatica2g.title')} - Mamuth</title>
      </Helmet>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {t('acessorioshidro.pneumatica2g.title')}
          </h2>

          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            {t('acessorioshidro.pneumatica2g.texto1')}
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            {t('acessorioshidro.pneumatica2g.texto2')}
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
         {t('acessorioshidro.pneumatica2g.texto3')}

          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
           {t('acessorioshidro.pneumatica2g.texto4')}
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
           {t('acessorioshidro.pneumatica2g.texto5')}
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
           {t('acessorioshidro.pneumatica2g.texto6')}
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
           {t('acessorioshidro.pneumatica2g.texto7')}
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center p-8 rounded-[30px] shadow-sm" style={{backgroundColor:'#d3d3d3'}}>
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h2 className="text-gray-800 text-2xl md:text-4xl font-bold">
              {t('acessorioshidro.pneumatica2g.textoCard')}
            </h2>
          </div>
