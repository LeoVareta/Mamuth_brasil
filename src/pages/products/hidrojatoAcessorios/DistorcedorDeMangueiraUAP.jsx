            ...
            <table className="w-full border-collapse table-fixed bg-white">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  ...
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[10%] uppercase">{t('tabela.modelo')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[10%] uppercase">{t('tabela.codigo')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[9%] uppercase">{t('tabela.pressao')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[13%] uppercase">{t('tabela.roscaaparafuso')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[13%] uppercase">{t('tabela.roscaaanilha')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[13%] uppercase">{t('tabela.roscabparafuso')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] md:text-xs text-center w-[13%] uppercase">{t('tabela.roscabanilha')}</th> 
                  <th className="py-4 px-1 font-bold text-[10px] md:text-xs text-center w-[16%] uppercase">{t('tabela.aplicacao')}</th>
                </tr>
              </thead>
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] md:text-sm text-center">3/4 UNF</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] md:text-sm text-center">3/8 UNF LH</td>
                  <td className="py-6 px-1 text-[10px] md:text-sm text-center">{t('tabela.mangueiras')} UAP</td>
                </tr>
                <tr className="text-gray-800 border-b border-gray-200">
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('acessorioshidro.distorcedor.title')}</h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-autoopacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    ...
                    <p><strong>{t('tabela.aplicacao')}:</strong> {t('tabela.mangueiras')} UAP</p>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
