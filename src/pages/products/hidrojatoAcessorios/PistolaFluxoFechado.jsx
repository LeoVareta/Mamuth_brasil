            ...
            <table className="w-full border-collapse table-fixed bg-white">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  <th className="py-6 px-1 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[auto] uppercase">{t('tabela.modelo')}</th>
                  <th className="py-6 px-1 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[auto] uppercase">{t('tabela.codigo')}</th>
                  <th className="py-6 px-1 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[auto] uppercase">{t('tabela.pressao')}</th>
                  <th className="py-6 px-1 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[auto] uppercase">{t('tabela.peso1')}</th>
                  <th className="py-6 px-1 border-r border-orange-400 font-bold text-sm md:text-base text-center w-[auto] uppercase">{t('tabela.entrada')}</th>
                  <th className="py-6 px-1 font-bold text-xs md:text-base text-center w-[auto] uppercase">{t('tabela.comprimento')}</th>
                </tr>
              </thead>
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-2 border-r border-gray-200 text-sm md:text-lg text-center font-bold">{t('acessorioshidro.fluxofechado.title')}</td>
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('acessorioshidro.fluxofechado.title')}</h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-autoopacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> {t('acessorioshidro.fluxofechado.title')}</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 1001.4005</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.200</p>
                    <p><strong>{t('tabela.peso1')}:</strong> 3,7</p>
                    <p><strong>{t('tabela.entrada')}:</strong> Engate ER - 12 M22 PL</p>
