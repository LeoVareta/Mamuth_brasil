            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  ...
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.codigo')}</th>
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.diametro')}</th>
                  ...
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.cabeca')}</th>
                  ...
                  <th className="py-4 px-1 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.conexaoentrada')}</th>
                </tr>
              </thead>
              <tbody>
                {[
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('bicos.rotativotitan.title')} </h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-auto opacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 9.5 22K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1050</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 9.5 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.500</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 15-23 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> M7</p>
                  </div>

                  {/* TITAN 13 22K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 13 22K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1055</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 13 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.500</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 20-34 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 1/8 BSP</p>
                  </div>

                  {/* TITAN 13 40K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 13 40K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1072</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 13 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 2.800</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 29-33 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 3/8-24 LH</p>
                  </div>

                  {/* TITAN 18 22K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 18 22K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1059</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 18 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.500</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 22-38 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 1/4 BSP</p>
                  </div>

                  {/* TITAN 18 40K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 18 40K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1077</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 18 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 2.800</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 42-64 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 3/8-24 LH</p>
                  </div>

                  {/* TITAN 24 22K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 24 22K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1065</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 24 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.500</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Polisher</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 42-64 LPM</p>
                  ...
                  {/* TITAN 33 22K */}
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> TITAN 33 22K</p>
                    <p><strong>{t('tabela.codigo')}:</strong> 2000.1086</p>
                    <p><strong>{t('tabela.diametro')}:</strong> 33 mm</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 1.500</p>
                    <p><strong>{t('tabela.cabeca')}:</strong> Universal</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 42-64 LPM</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 1/2 BSP</p>
                  </div>
                  </div>
                </div>
            </div>
