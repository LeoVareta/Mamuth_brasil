  ...
  const produtosDaCategoria = [
   {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/valvula-de-succao-uap',
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/valvula-de-pressao-sap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade.',
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/valvula-de-pressao-uap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
       ...
       {
         name: 'Sede dupla UAP',
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/sede-dupla-uap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
         image: sedeDuplaUAP, 
         category: 'Categoria Principal'
       },{
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/kit-de-vedacao-uap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
         image: kitVedacaoUAP, 
         category: 'Categoria Principal'
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/kit-de-vedacao-sap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
         image: kitVedacaoSAP, 
         category: 'Categoria Principal'
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/intermediaria-uap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/intermediaria-sap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade  ',
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/cesto-tampao-uap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade. ',
       ...
       },
       {
         ...
         path: '/pecas-para-bombas-de-hidrojatos/pecas-bombas-nacionais/cesto-tampao-sap',
         description: 'A MAMUTH oferece uma linha completa de peças para Bombas de Alta e Ultra-Alta Pressão, abrangendo diversas marcas e modelos disponíveis no mercado. Nossas peças são de fabricação própria, o que nos permite garantir altos padrões de qualidade e durabilidade.',
      ...
      <section className="pb-20 pt-20" style={{ backgroundColor: 'var(--color-dark-blue)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              Peças para bombas de hidrojato Nacionais
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
...
export default BombasNacionais;