...
const PistaoMetalDuroUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Pistal de Metal Duro UAP', cover: pistaoMetalUAP, color: '#FF5101' },
        { id: 2, title: 'Pistal de Metal Duro UAP', cover: pistaoMetalUAP, color: '#FF5101' },
        { id: 3, title: 'Pistal de Metal Duro UAP', cover: pistaoMetalUAP, color: '#FF5101' }
  ];
