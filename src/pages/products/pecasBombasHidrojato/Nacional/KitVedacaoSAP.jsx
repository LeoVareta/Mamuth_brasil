...
const KitVedacaoSAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Kit de Vedação SAP', cover: kitVedacaoSAP, color: '#FF5101' },
        { id: 2, title: 'Kit de Vedação SAP', cover: kitVedacaoSAP, color: '#FF5101' },
        { id: 3, title: 'Kit de Vedação SAP', cover: kitVedacaoSAP, color: '#FF5101' }
  ];
