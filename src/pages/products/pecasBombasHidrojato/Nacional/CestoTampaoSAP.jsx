...
const CestoTampaoSAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Cesto Tampão SAP', cover: cestoTampaoSAP, color: '#FF5101' },
        { id: 2, title: 'Cesto Tampão SAP', cover: cestoTampaoSAP, color: '#FF5101' },
        { id: 3, title: 'Cesto Tampão SAP', cover: cestoTampaoSAP, color: '#FF5101' }
  ];
