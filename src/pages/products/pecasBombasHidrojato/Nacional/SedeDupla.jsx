...
const SedeDupla = () => {
  ...
  const slides = [
        { id: 1, title: 'Sede Dupla', cover: sedeDupla, color: '#FF5101' },
        { id: 2, title: 'Sede Dupla', cover: sedeDupla, color: '#FF5101' },
        { id: 3, title: 'Sede Dupla', cover: sedeDupla, color: '#FF5101' }
  ];
