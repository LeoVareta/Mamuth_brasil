...
const IntermediariaUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Intermediária UAP', cover: intermediariaUAP, color: '#FF5101' },
        { id: 2, title: 'Intermediária UAP', cover: intermediariaUAP, color: '#FF5101' },
        { id: 3, title: 'Intermediária UAP', cover: intermediariaUAP, color: '#FF5101' }
  ];
