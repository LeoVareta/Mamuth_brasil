...
const CestoTampaoUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Cesto Tampão UAP', cover: cestoTampaoUAP, color: '#FF5101' },
        { id: 2, title: 'Cesto Tampão UAP', cover: cestoTampaoUAP, color: '#FF5101' },
        { id: 3, title: 'Cesto Tampão UAP', cover: cestoTampaoUAP, color: '#FF5101' }
  ];
