...
const PistaoMetalDuroSAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Pistão de Metal Duro SAP', cover: pistaoMetalSAP, color: '#FF5101' },
        { id: 2, title: 'Pistão de Metal Duro SAP', cover: pistaoMetalSAP, color: '#FF5101' },
        { id: 3, title: 'Pistão de Metal Duro SAP', cover: pistaoMetalSAP, color: '#FF5101' }
  ];
