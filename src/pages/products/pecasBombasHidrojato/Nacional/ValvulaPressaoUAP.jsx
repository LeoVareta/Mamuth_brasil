...
const ValvulaPressaoUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Válvula Pressão UAP', cover: valvulaPressaoUAP, color: '#FF5101' },
        { id: 2, title: 'Váuvula Pressão UAP', cover: valvulaPressaoUAP, color: '#FF5101' },
        { id: 3, title: 'Váuvula Pressão UAP', cover: valvulaPressaoUAP, color: '#FF5101' }
  ];
