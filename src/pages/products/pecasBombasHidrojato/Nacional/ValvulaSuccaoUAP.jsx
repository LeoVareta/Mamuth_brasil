...
const ValvulaSuccaoUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Válvula Sucção UAP', cover: valvulaSuccaoUAP, color: '#FF5101' },
        { id: 2, title: 'Válvula Sucção UAP', cover: valvulaSuccaoUAP, color: '#FF5101' },
        { id: 3, title: 'Válvula Sucção UAP', cover: valvulaSuccaoUAP, color: '#FF5101' }
  ];
