            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-6 px-1 border-r border-gray-200 font-bold text-[10px] sm:text-xs md:text-base text-center">VB-200 {t('tabela.altavazao')}</td>
                  ...
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">1" BSP</td>
                  <td className="py-6 px-1 text-[10px] sm:text-xs md:text-base text-center leading-tight italic">{t('tabela.reguladorpressao')}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('acessorioslavadoras.valvulareguladora200.title')}</h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-autoopacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> VB-200 {t('tabela.altavazao')}</p>
                    <p><strong>{t('tabela.pressao')}:</strong> 200	</p>
                    <p><strong>{t('tabela.pressao2')}:</strong>2.900</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 200</p>
                    <p><strong>{t('tabela.conexaoentrada')}:</strong> 1" BSP</p>
                    <p><strong>{t('tabela.conexaosaida')}:</strong> 1" BSP</p>
