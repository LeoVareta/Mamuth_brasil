...
const Pistola660bar = () => {
  ...
  const slides = [
        { id: 1, title: t('acessorioslavadoras.pistola660.title'), cover: pistola660bar, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>{t('acessorioslavadoras.pistola660.title')} - Mamuth</title>
      </Helmet>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {t('acessorioslavadoras.pistola660.title')}
          </h2>

          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
           {t('acessorioslavadoras.pistola660.texto1')}
          </p>
        </div>
      </section>
      ...
      <section className="py-1 px-4 bg-white">
        <div className="max-w-4x md:block hidden mx-auto text-center p-8 rounded-[30px] shadow-sm" style={{backgroundColor:'#d3d3d3'}}>
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h2 className="text-gray-800 text-2xl md:text-4xl font-bold">
              {t('acessorioslavadoras.pistola660.textoCard')}
            </h2>
          </div>
            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  ...
                  <th className="py-4 px-1 border-r border-orange-400 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.conexaoentrada')}</th>
                  ...
                  <th className="py-4 px-1 font-bold text-[10px] sm:text-xs md:text-sm text-center">{t('tabela.comprimento')}</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-6 px-1 border-r border-gray-200 font-bold text-[10px] sm:text-xs md:text-base text-center">{t('acessorioslavadoras.pistola660.title')}</td>
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('acessorioslavadoras.pistola660.title')}</h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-autoopacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> {t('acessorioslavadoras.pistola660.title')}</p>
