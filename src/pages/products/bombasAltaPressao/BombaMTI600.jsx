...
const BombaMTI600 = () => {
  ...
  const slides = [
        { id: 1, title: t('bombas.600.title'),  cover: bombaMTI600, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>{t('bombas.600.title')} - Mamuth</title>
      </Helmet>
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-auto opacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> MTI-600</p>
                    <p><strong>{t('tabela.pressao')} (bar):</strong> 600</p>
                    <p><strong>{t('tabela.vazao')}:</strong> 35 </p>
                    <p><strong>{t('tabela.potencia')}:</strong> 50 </p>
                    <p><strong>{t('tabela.rotacao')}:</strong> 1750 </p>
                    <p><strong>{t('tabela.eixo')} (mm):</strong> 30 </p>
                  </div>
                </div>
              </div>
            </div>
