...
const BombaMTI500 = () => {
  ...
  const slides = [
        { id: 1, title: t('bombas.500.title'),  cover: bombaMTI500, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>{t('bombas.500.title')} - Mamuth</title>
      </Helmet>
          ...
          <div>
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                ...
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">{t('bombas.500.title')} </h3>
                ...
                <div className={`transition-all duration-300 ease-in-out ${aberto === 't1' ? 'h-auto opacity-100 p-5 pt-0' : 'max-h-0 opacity-0'}`}>
                  <div className="grid grid-cols-2 gap-2 text-sm border-t py-4">
                    <p><strong>{t('tabela.modelo')}:</strong> MTI-500</p>
                    <p><strong>{t('tabela.pressao')} (bar):</strong> 500</p>
