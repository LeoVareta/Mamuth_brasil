      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            A Falch FA 500 é uma bomba de pistão de ultra alta capacidade desenvolvida para aplicações industriais de grande porte que exigem altíssima vazão combinada com pressões elevadas, garantindo máxima produtividade em operações contínuas.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            Com potência de até 500 kW e operação em pressões de até 3.000 bar, a FA 500 é indicada para cenários críticos onde desempenho, robustez e confiabilidade são indispensáveis, como hidrodemolição pesada, aplicações offshore, mineração, estaleiros e grandes operações industriais.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            Projetada com a engenharia alemã da Falch, essa bomba foi construída para suportar regimes intensivos de trabalho, reduzindo custos operacionais e garantindo alta disponibilidade ao longo do tempo.
          </p>
          <h3 
            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">Horizontal ou vertical</td>
                </tr>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                ...
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">Aproximadamente 1430 kg</td>
                </tr>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                ...
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">Lubrificação por circulação de pressão</td>
                </tr>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                ...
                {/* Container com Margem Lateral (p-5) */}
                  <div className="p-5 px-12 pt-2"> 
                    <div className="grid grid-cols-2 gap-2 text-sm border-t pb-4 pt-4">
                      ...
                      <p><strong>Rotação motor:</strong> 1500 rpm</p>
                      <p><strong>Rotação virabrequim:</strong> 528 rpm</p>
                      <p><strong>Potência(KW):</strong>122</p>
                      <p><strong>Vazão (L/min):</strong> 280 </p>
                    </div>
                    <div className="grid grid-cols-2 gap-2 text-sm border-t pb-4 pt-4">
                      ...
                      <p><strong>Vazão (L/min):</strong> 180 </p>
                    </div>
                    <div className="grid grid-cols-2 gap-2 text-sm border-t pb-4 pt-4">
                      ...
                      <p><strong>Vazão (L/min):</strong> 110 </p>
                    </div>
                    <div className="grid grid-cols-2 gap-2 text-sm border-t pb-4 pt-4">
